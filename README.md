...
```bash
indoor-iot-backend$ sam logs -n HelloWorldFunction --stack-name indoor-iot-backend --tail
```
...
```bash
indoor-iot-backend$ cd HelloWorldFunction
...
```bash
aws cloudformation delete-stack --stack-name indoor-iot-backend
```
